...
from models import ResNet18, UNet
...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epochs + 1):
        clean_loss, poison_loss = bome(args, attacker, classifier, cls_optimizer,
                                       atk_optimizer, train_loader, args.iterations, epoch)
